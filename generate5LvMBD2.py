...
class generateMBD():
    ...
    def insertOrder(self, caa, exchgTm, ApplSeqNum, side, orderType, price, qty):
        ...
        if self.prevMktApplSeqNum > 0:
            ...
            hasUnfrozen = self.guessNBBO(caa, exchgTm, ApplSeqNum1, self.aggSide, record=True)        
    ...
    def removeOrderByTrade(self, caa, exchgTm, ApplSeqNum, price, qty, BidApplSeqNum, OfferApplSeqNum):
        ...
        if BidApplSeqNum in self.frozenOrderDict:
            ...
            self.unfrozen(bidOrderPrice, 1, self.bidDict, self.frozenBidDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                              self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount)
            hasUnfrozen = 1
        ...
        if OfferApplSeqNum in self.frozenOrderDict:
            self.askDict, self.frozenAskDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                              self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount =\
            self.unfrozen(askOrderPrice, 2, self.askDict, self.frozenAskDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                              self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount)
            hasUnfrozen = 1
    ...
    def guessNBBO(self, caa, exchgTm, ApplSeqNum, aggSide, record=True):
        ...
        self.matchTrades(fakeBidDict, fakeAskDict, self.cum_volume, self.cum_amount, self.close, fakeBidnq1, fakeBidnq2, fakeAsknq1, fakeAsknq2, fakeInsertion_bid, fakeInsertion_ask, self.bid_qty, \
        ...
        if (self.skey >= 2300000) & (self.date >= 20200824):
            if aggSide == 1 and len(self.frozenBidDict) > 0:
                ...
                while len(self.frozenBidDict) > 0 and min(self.frozenBidDict.keys()) <= fakeMinBuyP:
                    ...
                    self.bidDict, self.frozenBidDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                                  self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount =\
                    self.unfrozen(fakeMinBuyP, 1, self.bidDict, self.frozenBidDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                                  self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount)
                    ...
                    self.unfrozen(fakeMinBuyP, 1, fakeBidDict, fakeFrozenBidDict, fakeFrozenOrderDict, fakeFrozenApplSeqNumDict, fakeBid_price_levels, fakeBid_order_nums, fakeBidnq1, fakeBidnq2, fakeBid_qty, fakeBid_amount, \
                                  fakeAsk_price_levels, fakeAsk_order_nums, fakeAsknq1, fakeAsknq2, fakeAsk_qty, fakeAsk_amount)
                    
                    fakeBidDict, fakeAskDict, fake_cum_volume, fake_cum_amount, fake_close, fakeBid1p, fakeAsk1p, fakeBidnq1, fakeBidnq2, fakeAsknq1, fakeAsknq2, fakeInsertion_bid, fakeInsertion_ask, fakeBid_qty, fakeAsk_qty, fakeBid_amount, \
                    fakeAsk_amount, fakeBid_price_levels, fakeAsk_price_levels, fakeBid_order_nums, fakeAsk_order_nums, fakeTrade_on_1p_buy_qty, fakeTrade_on_1p_sell_qty, fakeTrade_on_1p_buy_amount, fakeTrade_on_1p_sell_amount, \
                    fakeTrade_over_1p_buy_qty, fakeTrade_over_1p_sell_qty, fakeTrade_over_1p_buy_amount, fakeTrade_over_1p_sell_amount, fakeHasTrade = \
                    self.matchTrades(fakeBidDict, fakeAskDict, fake_cum_volume, fake_cum_amount, fake_close, fakeBidnq1, fakeBidnq2, fakeAsknq1, fakeAsknq2, fakeInsertion_bid, fakeInsertion_ask, fakeBid_qty, fakeAsk_qty, fakeBid_amount, \
                    fakeAsk_amount, fakeBid_price_levels, fakeAsk_price_levels, fakeBid_order_nums, fakeAsk_order_nums, fakeTrade_on_1p_buy_qty, fakeTrade_on_1p_sell_qty, fakeTrade_on_1p_buy_amount, fakeTrade_on_1p_sell_amount, \
            ...
            if aggSide == 2 and len(self.frozenAskDict) > 0:
                ...
                while len(self.frozenAskDict) > 0 and max(self.frozenAskDict.keys()) >= fakeMaxSellP:
                    ...
                    self.askDict, self.frozenAskDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                                  self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount =\
                    self.unfrozen(fakeMaxSellP, 2, self.askDict, self.frozenAskDict, self.frozenOrderDict, self.frozenApplSeqNumDict, self.bid_price_levels, self.bid_order_nums, self.bidnq1, self.bidnq2, self.bid_qty, self.bid_amount, \
                                  self.ask_price_levels, self.ask_order_nums, self.asknq1, self.asknq2, self.ask_qty, self.ask_amount)
                    fakeAskDict, fakeFrozenAskDict, fakeFrozenOrderDict, fakeFrozenApplSeqNumDict, fakeBid_price_levels, fakeBid_order_nums, fakeBidnq1, fakeBidnq2, fakeBid_qty, fakeBid_amount, \
                                  fakeAsk_price_levels, fakeAsk_order_nums, fakeAsknq1, fakeAsknq2, fakeAsk_qty, fakeAsk_amount = \
                    self.unfrozen(fakeMaxSellP, 2, fakeAskDict, fakeFrozenAskDict, fakeFrozenOrderDict, fakeFrozenApplSeqNumDict, fakeBid_price_levels, fakeBid_order_nums, fakeBidnq1, fakeBidnq2, fakeBid_qty, fakeBid_amount, \
                                  fakeAsk_price_levels, fakeAsk_order_nums, fakeAsknq1, fakeAsknq2, fakeAsk_qty, fakeAsk_amount)
    ...
    def matchTrades(self, bidDict, askDict, cum_volume, cum_amount, close, bidnq1, bidnq2, asknq1, asknq2, insertion_bid, insertion_ask, bid_qty, ask_qty, bid_amount, ask_amount, bid_price_levels, ask_price_levels, \
    ...
    def unfrozen(self, price, side, orderbookDict, frozenOrderbookDict, frozenOrderDict, frozenApplSeqNumDict, bid_price_levels, bid_order_nums, bidnq1, bidnq2, bid_qty, bid_amount, ask_price_levels, ask_order_nums,
