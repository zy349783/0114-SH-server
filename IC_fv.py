...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 15 18:11:31 2020
...
class SimMktSnapshotAllNew():
    ...
    def getAllInfo(self):
        ...
        lst = [mdDataBase, bidp, bidq, bidn, bidInsert, bidCancel, bidCancelSize,
        ...
        targetCols = (['time', 'clockAtArrival', 'sequenceNo', 'StockID', 'cum_volume', 'cum_amount', 'close', 'open', 'bbo_improve'] +
                      ...
                      + an_names + bqInsert_names[::-1] + aqInsert_names +
...
if __name__ == '__main__':
    ...
    # start date
    thisDate = datetime.date(2018, 9, 1)
    while thisDate <= datetime.date(2020, 7, 31):
        ...
        print(thisDate)
        os.mkdir('/mnt/e/mbd_data_IC/' + thisDate_str)
        ...
        test_list2 = list(re['skey'].values.astype('int64'))
        m = len(test_list2)
