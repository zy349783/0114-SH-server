...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 14 17:29:10 2020
...
class go():
    def __init__(self, orders_data, trades_data):
...
if __name__ == '__main__':
    ...
    while thisDate <= datetime.date(2017, 3, 1):
        thisDate_str = str(thisDate).replace('-', '')
        mdIndex = db.read('md_index', thisDate_str, thisDate_str, symbol=1000300)
        if mdIndex is None:
        ...
        sl1 = mdTradeLog['skey'].unique()
        sl2 = mdOrderLog['skey'].unique()
        orders_data = {}
        trades_data = {}
